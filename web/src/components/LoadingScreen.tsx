...
export default function LoadingScreen() {
  return (
    <div className="flex flex-col min-h-screen bg-amber-50 dark:bg-slate-900 relative">
      <div
        className="absolute inset-0 bg-[url('/noise.jpg')] bg-repeat opacity-10 dark:opacity-5"
      />
      <div
      ...
      <div className="flex-1 flex items-center justify-center relative z-10">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center space-x-2">
            <div className="h-2 w-2 bg-amber-600 dark:bg-amber-500 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
            <div className="h-2 w-2 bg-amber-600 dark:bg-amber-500 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
            <div className="h-2 w-2 bg-amber-600 dark:bg-amber-500 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
          </div>

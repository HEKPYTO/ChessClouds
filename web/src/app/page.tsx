  ...
  return (
    <>
      <section className="pt-16 pb-20 md:pt-24 md:pb-28 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-amber-50/70 to-amber-100/50">
          <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-amber-900 max-w-4xl mx-auto leading-tight font-display">
          ...
          <div className="mt-10 flex justify-center space-x-4">
            <Button
              ...
              ${
                pressedKey === 'p'
                  ? 'transform translate-y-[4px] shadow-none bg-amber-700'
                  : ''
              }`}
            ...
            <Button
              ...
              ${
                pressedKey === 's'
                  ? 'transform translate-y-[4px] shadow-none bg-amber-100'
                  : ''
              }`}
          ...
          <div className="mt-6 flex justify-center items-center text-sm text-amber-700">
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/50 backdrop-blur-sm border border-amber-200/50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all">
              <div className="flex items-center mb-4">
                <div className="h-8 w-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 mr-3">
                  <BoltIcon className="h-5 w-5" />
                </div>
                <h3 className="text-lg font-medium text-amber-900">Fast</h3>
              </div>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-amber-900 font-display text-center mb-8">
            Experience Chess in a New Way
          </h2>
          <div className="bg-amber-50 backdrop-blur-sm border border-amber-200/40 p-8 rounded-lg shadow-lg relative overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="order-2 md:order-1">
                <h2 className="text-2xl font-bold text-amber-900 mb-4 font-display">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                  ...
                  >
                    ...
                    <span
                      className={`ml-1 text-xs px-1 rounded transition-colors ${
                        pressedKey === 's' ? 'bg-amber-800' : 'bg-amber-700'
                      }`}
                    >
                      S
                    </span>
              ...
              <div className="relative flex items-center justify-center order-1 md:order-2">
                <div className="w-full">
                  <CustomChessBoard className="shadow-xl" pgn={pgn} />
                </div>
              </div>
            </div>
          </div>
